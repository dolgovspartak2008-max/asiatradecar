...
export type FavoriteCar = Omit<Pick<Car, "id" | "slug" | "country" | "make" | "model" | "trim" | "year" | "mileageKm" | "engineCc" | "powerHp" | "drive" | "priceRub" | "photos">, "photos"> & { photos: readonly string[] };
