...
export function Footer() {
  return <footer className="site-footer" id="contacts">
    <div className="container footer-grid">
      ...
      <div><h2>Навигация</h2><Link href="/catalog?country=kr">Каталог</Link><Link href="/calculator">Калькулятор</Link><Link href="/orders">Как заказать</Link><Link href="/#process">Этапы работы</Link></div>
