...
export default async function Home() {
  const organization = buildOrganizationSchema({ name: site.name, owner: site.owner, inn: site.inn, ogrn: site.ogrn, address: site.address, url: site.url, logo: "/media/asia-trade-car-logo-transparent.webp", phone: site.phone, email: site.email, sameAs: [site.telegram, site.youtube, site.vk] });
  return <>
