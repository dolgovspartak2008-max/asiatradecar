...
export default function OrdersPage() {
  return <>
    ...
    <section className="section orders-sources"><div className="container content-sheet"><h2>Официальные источники</h2><p>Правила и статусы документов могут меняться. Перед оформлением сверяйте актуальную информацию в первичных источниках:</p><ul><li><a href="https://cpt.customs.gov.ru/fiz/transportnye-sredstva-" target="_blank" rel="noreferrer">ФТС России: транспортные средства для физических лиц</a></li><li><a href="https://elpts.ru/" target="_blank" rel="noreferrer">Система электронных паспортов: ЭПТС</a></li></ul></div></section>

    <section className="section orders-faq"><div className="container"><div className="section-heading"><div><h2>Частые вопросы</h2></div><p>Короткие ответы до начала подбора.</p></div><div className="faq-list"><details><summary>Можно выбрать конкретный автомобиль?</summary><p>Да. Откройте каталог, сохраните интересующие лоты или укажите модель и номер лота в заявке.</p></details><details><summary>Стоимость фиксируется заранее?</summary><p>До выкупа формируется расчёт по известным расходам. Изменяемые платежи и допущения показываются отдельно.</p></details><details><summary>Можно заказать автомобиль, которого нет на первой странице?</summary><p>Да. Обычные ссылки на следующую и предыдущую страницы открывают весь каталог; кнопка «Показать ещё» остаётся для быстрого просмотра.</p></details><details><summary>Что происходит после заявки?</summary><p>Менеджер уточняет требования, предлагает варианты и только после вашего согласия начинает проверку выбранного автомобиля.</p></details></div></div></section>
